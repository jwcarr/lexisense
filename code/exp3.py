...
##############################################################################
experiment = exp_analysis.Experiment('exp3')
...
# model_fit.create_surrogate_likelihood(experiment.left, core.MODEL_FIT/'exp3_left_likelihood2.pkl')
# model_fit.create_surrogate_likelihood(experiment.right, core.MODEL_FIT/'exp3_right_likelihood.pkl')
# model_fit.create_surrogate_likelihood(experiment, core.MODEL_FIT/'exp3_likelihood.pkl')
...
##############################################################################
# exp_analysis.plot_uncertainty_prediction(experiment, core.MODEL_FIT/'exp3.pkl', core.FIGS/'uncertainty_prediction.eps')
