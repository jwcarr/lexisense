...
# exp_analysis.calculate_median_completion_time(experiment, use_first_trial_time=True)
...
##############################################################################
# import model_fit
# initial_evaluation = [0.765, 0.125, 0.0, 0.125]
# model_fit.create_surrogate_likelihood(experiment.left, core.MODEL_FIT/'exp1_left_likelihood.pkl', initial_evaluation)
# model_fit.create_surrogate_likelihood(experiment.right, core.MODEL_FIT/'exp1_right_likelihood.pkl', initial_evaluation)
# model_fit.create_surrogate_likelihood(experiment, core.MODEL_FIT/'exp1_likelihood.pkl', initial_evaluation)
...
##############################################################################
# exp_analysis.make_posterior_projections_figure(experiment, core.FIGS/'posterior_projections_new.eps')


##############################################################################
# Plot posterior predictive checks
##############################################################################
# exp_analysis.plot_posterior_predictive_checks(experiment, core.FIGS/'posterior_predictive_new.eps')
